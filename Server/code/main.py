...
from storage.chat_storage import TextChatUserStorage
from utilities.registers import RegisterFactory

#registers initialization
register_factory=RegisterFactory()
auth_user_register=register_factory.get_authorized_user_register()
active_user_register=register_factory.get_active_user_register()
active_chat_register=register_factory.get_active_chat_register(active_user_register, TextChatUserStorage(), Chat)
